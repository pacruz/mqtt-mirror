...
parser.add_argument("--source-port", type=int, help="Source broker port", default=1883)
...
parser.add_argument("--destination-port", type=int, help="Destination broker port", default=1883)
